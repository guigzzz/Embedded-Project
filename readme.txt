...
Control: user inputs a target for greenhouse light intensity from a remote device. Through the broker, the main reads the input 
and regulates light intensity using an LED, located near the ambient light sensor in order to converge towards the target conditions.
